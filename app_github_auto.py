...
with st.expander("🧰 Debug & Config GitHub", expanded=False):
    st.write({"DB_PATH": DB_PATH.as_posix(),"GH_REPO": GH_REPO,"GH_BRANCH": GH_BRANCH,"GH_PATH": GH_PATH,"GH_TOKEN_present": bool(GH_TOKEN),"last_digest": st.session_state._last_digest,"current_digest": _current_digest})
